...
def problem_4(I_gray, I_color):
  ...
  corners = feature.corner_harris(I_gray, k=0.245)
  ...
  return (coordinates, sift_descriptor)

# process and read in image 1
I1 = img_as_float32(io.imread('image1.jpg')).astype(np.float16)
...
if I1.ndim == 3:
    image1 = color.rgb2gray(I1)

# process and read in image 2
I2 = img_as_float32(io.imread('image2.jpg')).astype(np.float16)
...
# Convert to grayscale if RGB
if I2.ndim == 3:
    image2 = color.rgb2gray(I2)

# compute corners and sift_descriptors for image1
coord_1, sift_descriptor_1 = problem_4(image1, I1)

# compute corners and sift_descriptors for image2
coord_2, sift_descriptor_2 = problem_4(image2, I2)
